package com.solutis.acabouomony.error;
...
public class GeneralException implements Serializable {
    ...
    public Map<String, Object> handleValidationInternalException(java.lang.Exception ex) {
    ...
    public Map<String, Object> handleEntityExistsException(EntityExistsException ex) {
    ...
    public Map<String, Object> handleGeneralException(Exception ex) {
        Map<String, Object> errors = new HashMap<>();
        errors.put("Erro", "Ocorreu um erro inesperado: " + ex.getMessage());
        errors.put("Código", HttpStatus.INTERNAL_SERVER_ERROR.value());
        return errors;
    }
}